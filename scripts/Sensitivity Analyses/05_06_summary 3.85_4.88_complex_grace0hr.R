...
p_load(tidyverse, here, data.table,boot,lubridate, skimr, naniar,gtsummary,
       ...
       officer,flextable,EValue)

# ===================================================
# パラメータ設定
# ===================================================
GRACE_HOURS <- 0  # 0 または 1 に変更
...
path2_step6 <- paste0("C:/Users/ryohe/Dropbox (個人)/Research/2025ROX_ImpactAnalysis/Manuscript/Table and figures/S.Table 6_ROX_strategy_effect_grace", GRACE_HOURS, "hr.docx")
