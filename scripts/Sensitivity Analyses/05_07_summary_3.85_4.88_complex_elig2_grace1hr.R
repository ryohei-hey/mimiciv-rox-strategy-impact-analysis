...
# ===================================================
# Sensitivity Analysis: Alternative Eligibility Criteria (elig2)
# ===================================================
GRACE_HOURS <- 1  # Grace period setting

cat("=== Sensitivity Analysis Settings ===\n")
cat("Analysis type: Alternative Eligibility Criteria (elig2)\n")
cat("Grace period:", GRACE_HOURS, "hour(s)\n\n")

# ===================================================
# Load bootstrap data for elig2 sensitivity analysis
# ===================================================

# File paths for elig2 sensitivity analysis
file_3.85 <- paste0("outputs/ROX/bootdata/bootstrap_graphs_3.85_elig2_r500_grace", GRACE_HOURS, "hr.rds")
file_4.88 <- paste0("outputs/ROX/bootdata/bootstrap_graphs_4.88_elig2_r500_grace", GRACE_HOURS, "hr.rds")
file_complex <- paste0("outputs/ROX/bootdata/bootstrap_graphs_complex_elig2_r500_grace", GRACE_HOURS, "hr.rds")
...
plot_filename <- paste0("outputs/ROX/sensitivity/Fig.cumulative_incidence_all_strategies_elig2_grace", GRACE_HOURS, "hr.png")
...
plot_filename_noCI <- paste0("outputs/ROX/sensitivity/Fig.cumulative_incidence_all_strategies_elig2_noCI_grace", GRACE_HOURS, "hr.png")
...
ggsave(paste0("outputs/ROX/sensitivity/Fig_trial1_ROX3.85_elig2_grace", GRACE_HOURS, "hr.png"),
       plot_trial1, width = 8, height = 6, dpi = 300)
ggsave(paste0("outputs/ROX/sensitivity/Fig_trial2_ROX4.88_elig2_grace", GRACE_HOURS, "hr.png"),
       plot_trial2, width = 8, height = 6, dpi = 300)
ggsave(paste0("outputs/ROX/sensitivity/Fig_trial3_TimeVarying_elig2_grace", GRACE_HOURS, "hr.png"),
...
ggsave(paste0("outputs/ROX/sensitivity/Fig_all_trials_combined_elig2_grace", GRACE_HOURS, "hr.png"),
       plot_combined_trials, width = 8, height = 16, dpi = 300)

cat("\nCombined trial figure saved:", paste0("outputs/ROX/sensitivity/Fig_all_trials_combined_elig2_grace", GRACE_HOURS, "hr.png"), "\n")
...
doc_comparison <- doc_comparison %>%
  body_add_par(paste0("Table. Comparison of Cumulative Mortality Outcomes Across ROX-Guided Intubation Strategies - Sensitivity Analysis (elig2, Grace Period: ", GRACE_HOURS, " hour)"),
               style = "heading 1") %>%
  body_add_flextable(ft_comparison)

doc_filename <- paste0("outputs/ROX/sensitivity/mortality_comparison_all_strategies_elig2_grace", GRACE_HOURS, "hr.docx")
...
path1 <- paste0("outputs/ROX/sensitivity/S.Tab_ROX_strategy_effect_elig2_grace", GRACE_HOURS, "hr.docx")
...
path1_step6 <- paste0("outputs/ROX/sensitivity/table_multiple_timepoints_elig2_grace", GRACE_HOURS, "hr.docx")
...
path2_step6 <- paste0("C:/Users/ryohe/Dropbox (個人)/Research/2025ROX_ImpactAnalysis/Manuscript/Table and figures/S.Table 7_ROX_strategy_effect_elig2_grace", GRACE_HOURS, "hr.docx")
...
# Save forest plot
forest_path1 <- paste0("outputs/ROX/sensitivity/Fig_forest_plot_elig2_grace", GRACE_HOURS, "hr.png")
...
forest_rd_path1 <- paste0("outputs/ROX/sensitivity/Fig_forest_plot_RD_elig2_grace", GRACE_HOURS, "hr.png")
...
# Save E-value table
evalue_path <- paste0("outputs/ROX/sensitivity/S.Tab_Evalue_sensitivity_elig2_grace", GRACE_HOURS, "hr.docx")
...
## Step 10: Summary -----
cat("\n=== Analysis Complete ===\n")
cat("Sensitivity Analysis: Alternative Eligibility Criteria (elig2)\n")
cat("Grace period:", GRACE_HOURS, "hour(s)\n")
