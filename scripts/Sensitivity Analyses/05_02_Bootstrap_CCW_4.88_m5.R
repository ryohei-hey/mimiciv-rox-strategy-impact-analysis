# ============================================================================
# Bootstrap Analysis for ROX < 4.88 Strategy with Multiple Imputation (m=5)
# ============================================================================
...
# Grace period: 1 hour
# Strategy: ROX-guided intubation with cutoff ROX < 4.88
# ============================================================================
...
cat("\n============================================================================\n")
cat("  Bootstrap Analysis: ROX < 4.88 Strategy (Multiple Imputation m=5)\n")
cat("============================================================================\n")
...
for(imp in 1:N_IMPUTATIONS) { #change
  ...
  # Save results
  output_file <- sprintf("outputs/ROX/bootdata/bootstrap_results_4.88_imp%d.rds", imp)
...
cat(sprintf("Results saved in: outputs/ROX/bootdata/bootstrap_results_4.88_imp*.rds\n\n"))
